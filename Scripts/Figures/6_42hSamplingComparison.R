...
# Plot Results
##########################################
load("~/Desktop/TimeCycleV3/Results/SlidingWindows/42HourComparison_Zhang_Ceiling.Rdata")
library(UpSetR)
library(tidyverse)
library(ggalluvial)
library(gridExtra)
...
ggplot(data,
       aes(x = threshold, stratum = overlaps, alluvium = gene,
...
pdf("~/Desktop/TimeCycleV3/Results/Figures/AluvOut42.pdf", width = 14, height = 5)
...
pdf("~/Desktop/TimeCycleV3/Results/Figures/42hCorr.pdf", width = 14, height = 5)

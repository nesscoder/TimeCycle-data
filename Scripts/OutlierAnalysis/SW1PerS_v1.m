...
%
	...
	% load tda
	javaclasspath('/home/emn6548/TimeCycle/Scripts/Synthetic/tda/jars/tda_1.0.0_unionFind3.jar')
	import shell.*

					
	tda = Tda();

	tda.RCA1({'settingsFile=/home/emn6548/TimeCycle/Scripts/Synthetic/tda/cts.txt', ['zp_value=',num2str(p)], 'distanceBoundOnEdges=2'}, SW_cloud);
